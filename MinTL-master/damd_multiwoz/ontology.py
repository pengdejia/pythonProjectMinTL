...
all_domain_slots = ['hotel-name', 'hotel-people', 'hotel-day', 'hotel-stay', 'attraction-type', 'attraction-name', 'taxi-leave', 'taxi-destination', 'taxi-departure', 'hotel-parking', 'hotel-internet', 'hotel-pricerange', 'hotel-area', 'train-day', 'train-arrive', 'train-destination', 'train-departure', 'train-people', 'restaurant-name', 'restaurant-people', 'restaurant-day', 'restaurant-time', 'attraction-area', 'train-leave', 'restaurant-food', 'restaurant-pricerange', 'hotel-type', 'restaurant-area', 'hotel-stars', 'taxi-arrive']

domain_slot_id_dict = {'hotel-name': 0, 'hotel-people': 1, 'hotel-day': 2, 'hotel-stay': 3, 'attraction-type': 4, 'attraction-name': 5, 'taxi-leave': 6, 'taxi-destination': 7, 'taxi-departure': 8, 'hotel-parking': 9, 'hotel-internet': 10, 'hotel-pricerange': 11, 'hotel-area': 12, 'train-day': 13, 'train-arrive': 14, 'train-destination': 15, 'train-departure': 16, 'train-people': 17, 'restaurant-name': 18, 'restaurant-people': 19, 'restaurant-day': 20, 'restaurant-time': 21, 'attraction-area': 22, 'train-leave': 23, 'restaurant-food': 24, 'restaurant-pricerange': 25, 'hotel-type': 26, 'restaurant-area': 27, 'hotel-stars': 28, 'taxi-arrive': 29}
id_domain_slot_dict = {0: 'hotel-name', 1: 'hotel-people', 2: 'hotel-day', 3: 'hotel-stay', 4: 'attraction-type', 5: 'attraction-name', 6: 'taxi-leave', 7: 'taxi-destination', 8: 'taxi-departure', 9: 'hotel-parking', 10: 'hotel-internet', 11: 'hotel-pricerange', 12: 'hotel-area', 13: 'train-day', 14: 'train-arrive', 15: 'train-destination', 16: 'train-departure', 17: 'train-people', 18: 'restaurant-name', 19: 'restaurant-people', 20: 'restaurant-day', 21: 'restaurant-time', 22: 'attraction-area', 23: 'train-leave', 24: 'restaurant-food', 25: 'restaurant-pricerange', 26: 'hotel-type', 27: 'restaurant-area', 28: 'hotel-stars', 29: 'taxi-arrive'}
